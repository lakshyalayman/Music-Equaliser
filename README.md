...
A real-time audio visualizer and DSP playground written in C using raylib, featuring hot-reloadable plugins, FFT, and interactive audio filters (EQ, LPF, HPF, etc.).
